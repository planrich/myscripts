...
*/
static void YUV422toRGBA(int width, int height, unsigned char *src, int *dst)
{
  int line, column;
...
static int frameRead(int * to)
{
  ...
  switch (io) {
    ...
    case IO_METHOD_READ:
      ...
      imageProcess(buffers[0].start, to);
      break;
#endif
    ...
    case IO_METHOD_MMAP:
      ...
      imageProcess(buffers[buf.index].start, to);
    ...
    case IO_METHOD_USERPTR:
      ...
      imageProcess((void *) buf.m.userptr, to);
